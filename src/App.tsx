...
export const FAUCET = new FaucetClient("https://fullnode.testnet.aptoslabs.com", "https://faucet.testnet.aptoslabs.com");
...
function App(this: any) {
    ...
    const isTestnet = (): boolean => {
        return Number(walletContextState.network?.chainId) === chainId || walletContextState.network?.name?.toLowerCase() === 'testnet';
    }
    ...
    return (
        <>
            ...
            {
                walletContextState.connected && !isTestnet() &&
                <Alert
                    message={`Wallet is connected to ${walletContextState.network?.name}.  Please connect to testnet`}
                    type="warning"/>
            }
            {
                walletContextState.connected && isTestnet() &&
